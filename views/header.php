...
<body>
    ...
    <!-- NAVBAR -->
    <header>
    <div class="container py-1"> <!-- Reduced padding top and bottom -->
    <div class="row py-2 pb-2 align-items-center"> <!-- Reduced padding top -->
        <div class="col-sm-4 col-lg-3 text-center text-sm-start d-flex align-items-center justify-content-start"> <!-- Logo aligned left -->
            <div class="main-logo me-3"> <!-- Added margin end to separate logo from icons -->
                <a href="index.php">
        ...
        <div class="col-sm-8 col-lg-9 d-flex justify-content-end"> <!-- Icons aligned right -->
            <ul class="d-flex list-unstyled mb-0"> <!-- Removed m-0 for better alignment -->
                <div class="d-none d-lg-flex align-items-center">
                    <?php if ($isLoggedIn): ?>
                    <li class="dropdown">
                        <a href="#" class="mx-2" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
