...
<body>
    ...
    <header>
        <div class="container py-1">
            ...
            <div class="row py-2 pb-2 align-items-center">
                <!-- Reduced padding top -->
                <div
                    class="col-sm-4 col-lg-3 text-center text-sm-start d-flex align-items-center justify-content-start">
                    <!-- Logo aligned left -->
                    <div class="main-logo me-3">
                        <!-- Added margin end to separate logo from icons -->
                        <a href="index.php">
                ...
                <div class="col-sm-8 col-lg-9 d-flex justify-content-end">
                    <!-- Icons aligned right -->
                    <ul class="d-flex list-unstyled mb-0">
                        <!-- Removed m-0 for better alignment -->
                        <div class="d-none d-lg-flex align-items-center">
                            ...
                            <li>
                                <div class="icon-cart">
                                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="filled"
                                        viewBox="0 0 18 20">
                        ...
                        <ul class="d-flex justify-content-end list-unstyled m-0">
                                ...
                                <div class="d-none d-lg-flex align-items-end">
                                    ...
                                    <li>
                                        <a href="./cart.php" class="icon-cart">
                                            <svg style="margin-top:-15px;" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="filled" viewBox="0 0 18 20">
                            ...
                            <div class="container">
                                <div class="offcanvas-body justify-content-center">
                                    <ul
                                        class="navbar-nav menu-list list-unstyled d-flex justify-content-center gap-md-3 mb-0">
                                        <li class="nav-item">
                                            <a href="index.php"
                                                class="nav-link <?php echo $currentPage == 'index.php' ? 'active' : ''; ?>">Home</a>
                                        </li>
