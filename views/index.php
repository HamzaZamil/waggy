    ...
    <div class="container py-5 mb-5">
        ...
        <div class=" swiper bestselling-swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="../inserted_img/sweater.jpg" class="img-fluid rounded-4"
                                alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                ...
                <div class="swiper-slide">
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="../inserted_img/9lives.jpg" class="img-fluid rounded-4"
                                alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
              ...
              New
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="../inserted_img/chew_toy.jpg"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="../inserted_img/hoodie.jpg" class="img-fluid rounded-4"
                                alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
              ...
              New
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="../inserted_img/3pcs.jpg" class="img-fluid rounded-4"
                                alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
