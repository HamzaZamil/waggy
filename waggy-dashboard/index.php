                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo htmlspecialchars($activeUserCount, ENT_QUOTES, 'UTF-8'); ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Sales</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                $<?php echo number_format($totalSales, 2); // Format the total sales value to 2 decimal places ?>
                            </div>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                    <?php echo htmlspecialchars($totalProducts); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        label: 'Total Sales ($)',
        data: sales,
        backgroundColor: 'rgb(78, 115, 223 , 0.2)',
